...
exports.sendFakeStatus2 = (from, teks) => {
        ...
        leo.sendMessage(from, teks, MessageType.text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "mimetype": "image/jpeg", "caption": '🔥❣️Sᥲm ყ Pᥱrrყ | NყᥲᥒBot🐬', "jpegThumbnail": fs.readFileSync(`./src/fake.jpg`)} } } })
...
exports.sendPdf = async(from, buffer, title = "chouteu330.pdf") => {

    await chouteu330.sendMessage(from, buffer, MessageType.document, { mimetype: Mimetype.pdf, title: title })
...
exports.sendFakeThumb = async(from, buffer, caption = "") => {
    ...
    await chouteu330.sendMessage(from, buffer, MessageType.image, options)
...
exports.downloadMedia = async(media) => {
    ...
    const filePath = await chouteu330.downloadAndSaveMediaMessage(media, `./temp/${getRandomExt()}`)
